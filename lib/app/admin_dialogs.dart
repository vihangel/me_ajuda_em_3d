...
import '../features/portal_management/presentation/create_portal_client_dialog.dart';
...
Widget? adminAction(
  ...
  return switch (index) {
    ...
    6 => ActionPill(
      icon: Icons.person_add_alt_rounded,
      label: 'Novo cliente portal',
      onPressed: () => showCreatePortalClientDialog(context, repo, refresh),
    ),
    _ => null,
  };
}
        ...
        children: [
          ...
          if (results.isEmpty)
            ...
            for (final r in results)
              ListTile(
                leading: CircleAvatar(child: Icon(_searchIcon(r.icon))),
                title: Text(r.title),
...
Future<void> showCreateOrderDialog(
  BuildContext context,
  OperationRepository repo,
  VoidCallback refresh,
) async {
      ...
      builder: (context, set) => AlertDialog(
            ...
            child: Column(
              ...
              children: [
                SegmentedButton<CustomerKind>(
                  segments: [
                    for (final v in CustomerKind.values)
        ...
        actions: [
          ...
          GradientButton(
            ...
            compact: true,
            onPressed: () async {
              await repo.createCustomerOrder(
...
Future<void> showCreateMaterialDialog(
  BuildContext context,
  OperationRepository repo,
  VoidCallback refresh,
) async {
...
Future<void> showReorderQueueSheet(
  BuildContext context,
  OperationRepository repo,
) async {
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          '${queue[i].client.name} • vence ${formatDate(queue[i].dueAt)}',
                          style: TextStyle(
                            color: Theme.of(
                              context,
